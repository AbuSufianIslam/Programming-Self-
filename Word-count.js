...
// Breakdown
// We'll have to go through the entire input string, and we're returning a map with every unique word. In the worst case every word is different, so our runtime and space cost will both be at least O(n)O(n).
