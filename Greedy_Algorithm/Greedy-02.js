...
let actual = highestProductOfThree([ 1, 2, 3, 4 ]);
let expected = 24;
...
const emptyArray = () => highestProductOfThree([]);
assertThrowsError(emptyArray, desc);

desc = 'error with one number';
const oneNumber = () => highestProductOfThree([ 1 ]);
assertThrowsError(oneNumber, desc);

desc = 'error with two numbers';
const twoNumber = () => highestProductOfThree([ 1, 1 ]);
